...
// (44100, AAC(Main), 3, 10, 1024)
// 0xff, 0xf9, 0xd0, 0xc0, 0x02, 0x3f, 0xfc, 
// 0x01, 0x18, 0x20, 0x01, 0x08, 0x80, 0x23, 0x04, 0x60, 0xe0, 
// (44100, AAC(Main), 2, 6, 1024)
0xff, 0xf9, 0xd0, 0x80, 0x01, 0xbf, 0xfc, 
0x21, 0x10, 0x04, 0x60, 0x8c, 0x1c, 
// 0xff, 0xf9, 0xd0, 0x80, 0x06, 0x3f, 0xfc, 
// 0xde, 0x02, 0x00, 0x4c, 0x61, 0x76, 0x63, 0x35, 0x37, 0x2e, 0x39, 0x36, 0x2e, 0x31, 0x30, 0x31, 
// 0x00, 0x41, 0x5e, 0x46, 0x89, 0xaa, 0x2e, 0xdc, 0xe5, 0x64, 0xb1, 0xd2, 0x8b, 0xfa, 0xbb, 0x99, 
// 0x41, 0xd0, 0xca, 0xd0, 0xf5, 0x75, 0x63, 0x18, 0x20, 0x07, 
    ...
    println!("{:?}", result);
    println!("{:?}", (frame.channels(), frame.rate(), frame.samples(), frame.planes(), frame.channel_layout(), frame.is_planar(), frame.is_packed(), frame.timestamp()));
    println!("{}", PrettyHex::new(frame.data(0)).with_opts((false, false, false)));
}